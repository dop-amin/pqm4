...
void __attribute__((naked)) fpadd751(const digit_t* a, const digit_t* b, digit_t* c)
...
void __attribute__((naked)) fpsub751(const digit_t* a, const digit_t* b, digit_t* c)
